...
from esdltools.api import app as esdltools
from esdltools.api.controller.validation import app as validationApi
from esdltools.api.controller.schema import app as schemaApi
...
def create_app():
    ...
    app = Flask(__name__)
    app.register_blueprint(esdltools.apiBlueprint, url_prefix=esdltools.settings.endpointPrefix)
    ...
    if esdltools.settings.useDefaultCors:
