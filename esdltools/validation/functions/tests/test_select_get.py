...
class TestSelect(unittest.TestCase):
    ...
    def test_select(self):
        ...
        profileAvg = FunctionFactory.create(FunctionType.SELECT, "avg", alias="profile_avg", data=data, args={"dataset": "influx_profiles", "property": "multiplier"})
        data[profileAvg.alias] = profileAvg.result
        profileSum = FunctionFactory.create(FunctionType.SELECT, "sum", alias="profile_count", data=data, args={"dataset": "influx_profiles", "property": "multiplier"})
