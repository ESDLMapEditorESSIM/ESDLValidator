...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" name="PoC_validator with return network" id="64d5d892-4896-4ab2-89e5-e191db4eeac6_with_return_network" description="" esdlVersion="v2207" version="4">
  <energySystemInformation xsi:type="esdl:EnergySystemInformation" id="e34599a1-c660-422a-9653-c6adfbc8eac4">
    <carriers xsi:type="esdl:Carriers" id="c081ae3d-af0e-45dd-92e1-52deb64f688a">
      ...
      <carrier xsi:type="esdl:HeatCommodity" id="3be4c7f5-4282-440c-988e-06ff4e54f597_ret" returnTemperature="60.0" name="highT_ret"/>
    </carriers>
  ...
  <instance xsi:type="esdl:Instance" id="0ef5d5cd-0984-4fe4-a742-efffafa6f8eb" name="Untitled instance">
    <area xsi:type="esdl:Area" id="ddab37d3-fd78-4ed2-a596-bda9c514ebb6" name="Untitled area">
      <asset xsi:type="esdl:GeothermalSource" name="GeothermalSource_6943" id="69435473-177a-4e0f-ac09-fb8a4bfadad0">
        <geometry xsi:type="esdl:Point" lon="4.37058448791504" lat="52.00156773139614" CRS="WGS84"/>
      ...
      <asset xsi:type="esdl:GenericProducer" name="GenericProducer_91e9" id="91e9b1d1-6ed3-4e0b-86e4-349f0da02131">
        <geometry xsi:type="esdl:Point" lon="4.374361038208009" lat="52.000127796500934" CRS="WGS84"/>
      ...
      <asset xsi:type="esdl:ResidualHeatSource" name="ResidualHeatSource_7b06" id="7b064789-cee6-4957-8b85-f6bb6d5559c7">
        <geometry xsi:type="esdl:Point" lon="4.376678466796876" lat="51.99673253728782" CRS="WGS84"/>
      ...
      <asset xsi:type="esdl:HeatStorage" name="HeatStorage_125d" id="125d49cd-5a03-47e3-9802-1b2bd9429d72">
        <geometry xsi:type="esdl:Point" lon="4.370949268341065" lat="51.99753843924036"/>
      ...
      <asset xsi:type="esdl:HeatingDemand" name="HeatingDemand_f246" id="f24682d8-a8ed-4029-9709-066d87e9cc7e">
        <geometry xsi:type="esdl:Point" lon="4.369661808013917" lat="51.99959936840761" CRS="WGS84"/>
      ...
      <asset xsi:type="esdl:GenericConsumer" name="GenericConsumer_4857" id="48574e2f-5ad8-4139-b566-4ac026abb477">
        <geometry xsi:type="esdl:Point" lon="4.370648860931397" lat="51.998317904376485" CRS="WGS84"/>
      ...
      <asset xsi:type="esdl:ATES" aquiferNetToGross="1.0" name="ATES_a032" aquiferThickness="45.0" wellCasingSize="13.0"
       maxDischargeRate="11610000.0" aquiferAnisotropy="4.0" aquiferPorosity="0.3" aquiferMidTemperature="17.0" aquiferTopDepth="300.0" id="a0322022-3113-4fbd-a0e9-2ec991e0523d" wellDistance="150.0" maxChargeRate="0.0" salinity="10000.0" aquiferPermeability="10000.0">
        <geometry xsi:type="esdl:Point" lon="4.372107982635499" lat="51.99634939848474" CRS="WGS84"/>
        ...
        <costInformation xsi:type="esdl:CostInformation">
          <variableOperationalCosts xsi:type="esdl:SingleValue" value="69666.67">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" description="Cost in EUR/yr" id="3c9f580e-b71a-4bc8-8cea-cb6788c0bf49" perTimeUnit="YEAR" unit="EURO"/>
          </variableOperationalCosts>
          <fixedMaintenanceCosts xsi:type="esdl:SingleValue" value="115472.22">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" description="Cost in EUR/yr" id="57537388-7fd7-40b3-a0c4-0ce65648eaab" perTimeUnit="YEAR" unit="EURO"/>
          </fixedMaintenanceCosts>
          <fixedOperationalCosts xsi:type="esdl:SingleValue" value="30000.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" description="Cost in EUR/yr" id="574ef21d-681a-43ae-a1cb-f7b25d88defb" perTimeUnit="YEAR" unit="EURO"/>
      ...
      <asset xsi:type="esdl:GenericConversion" name="GenericConversion_a735" id="a7351e21-9d5e-4fb9-b6bf-42188a59f6d9">
        <geometry xsi:type="esdl:Point" lon="4.3708205223083505" lat="51.99992963669694" CRS="WGS84"/>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe1_ret" diameter="DN200" name="Pipe1" length="160.1" id="Pipe1">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.372107982635499" lat="51.99634939848474"/>
          <point xsi:type="esdl:Point" lon="4.374293982982636" lat="51.99685969901065"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe2_ret" diameter="DN200" name="Pipe2" length="179.9" id="Pipe2">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.370949268341065" lat="51.99753843924036"/>
          <point xsi:type="esdl:Point" lon="4.373373985290528" lat="51.99816102159465"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Joint" name="Joint_ff92" id="ff92b034-ff9f-4810-a67c-192da985adb0">
        <geometry xsi:type="esdl:Point" lon="4.372985064983369" lat="51.99877864115756"/>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe3_ret" diameter="DN200" name="Pipe3" length="73.43" id="Pipe3">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.37344640493393" lat="51.99818248979724"/>
          <point xsi:type="esdl:Point" lon="4.372985064983369" lat="51.99877864115756"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Joint" name="Joint_8fbf" id="8fbf512c-7c77-469e-b1c5-170dc7e3ac40">
        <geometry xsi:type="esdl:Point" lon="4.37344640493393" lat="51.99818248979724"/>
      ...
      <asset xsi:type="esdl:HeatExchange" name="HeatExchange_3917" id="39179dff-ed97-45c4-a4b7-0a885c59faa7">
        <geometry xsi:type="esdl:Point" lon="4.373379349708558" lat="51.999890004630885" CRS="WGS84"/>
      ...
      <asset xsi:type="esdl:HeatPump" name="HeatPump_811e" id="811e1536-d7f9-4853-bfa0-06a8377d6442">
        <geometry xsi:type="esdl:Point" lon="4.3710458278656015" lat="52.00103932030095" CRS="WGS84"/>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe4_ret" diameter="DN200" name="Pipe4" length="107.05" id="Pipe4">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.372985064983369" lat="51.99877864115756"/>
          <point xsi:type="esdl:Point" lon="4.37232792377472" lat="51.99965221149765"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Joint" name="Joint_282a" id="282ad13c-91ee-4e51-a0db-2bd24cf8d789">
        <geometry xsi:type="esdl:Point" lon="4.37232792377472" lat="51.99965221149765"/>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe5_ret" diameter="DN200" name="Pipe5" length="205.45" id="Pipe5">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.376678466796876" lat="51.99673253728782"/>
          <point xsi:type="esdl:Point" lon="4.374747276306153" lat="51.996336186743406"/>
          <point xsi:type="esdl:Point" lon="4.374350309371949" lat="51.99687786494158"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe6_ret" diameter="DN200" name="Pipe6" length="157.72" id="Pipe6">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.374350309371949" lat="51.99687786494158"/>
          <point xsi:type="esdl:Point" lon="4.373502731323243" lat="51.99810652534175"/>
          <point xsi:type="esdl:Point" lon="4.37344640493393" lat="51.99818248979724"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Joint" name="Joint_0573" id="05734efb-c631-4294-91f6-d27c221b0a96">
        <geometry xsi:type="esdl:Point" lon="4.374350309371949" lat="51.99687786494158"/>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe7_ret" diameter="DN200" name="Pipe7" length="72.62" id="Pipe7">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.37232792377472" lat="51.99965221149765"/>
          <point xsi:type="esdl:Point" lon="4.371786117553712" lat="52.00021366547689"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe8_ret" diameter="DN200" name="Pipe8" length="93.52" id="Pipe8">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.371126294136048" lat="52.000950150313486"/>
          <point xsi:type="esdl:Point" lon="4.371786117553712" lat="52.00021366547689"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Joint" name="Joint_2bec" id="2bec564e-c47d-4450-b036-c65de6f1069c">
        <geometry xsi:type="esdl:Point" lon="4.371786117553712" lat="52.00021366547689"/>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe9_ret" diameter="DN200" name="Pipe9" length="72.2" id="Pipe9">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lon="4.374361038208009" lat="52.000127796500934"/>
          <point xsi:type="esdl:Point" lon="4.373379349708558" lat="51.999890004630885"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe10_ret" diameter="DN200" name="Pipe10" length="66.7" id="Pipe10">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lon="4.37058448791504" lat="52.00156773139614"/>
          <point xsi:type="esdl:Point" lon="4.3710458278656015" lat="52.00103932030095"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe11_ret" diameter="DN200" name="Pipe11" length="73.3" id="Pipe11">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lon="4.371786117553712" lat="52.00021366547689"/>
          <point xsi:type="esdl:Point" lon="4.3708205223083505" lat="51.99992963669694"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe13_ret" diameter="DN200" name="Pipe13" length="87.4" id="Pipe13">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lon="4.3708205223083505" lat="51.99992963669694"/>
          <point xsi:type="esdl:Point" lon="4.369661808013917" lat="51.99959936840761"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe14_ret" diameter="DN200" name="Pipe14" length="167.9" id="Pipe14">
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lon="4.372985064983369" lat="51.99877864115756"/>
          <point xsi:type="esdl:Point" lon="4.370648860931397" lat="51.998317904376485"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Joint" name="Joint_ff92_ret" id="35bb0bef-8129-4904-9a55-5300e5c2950e">
        <geometry xsi:type="esdl:Point" lon="4.372198467776014" lat="51.998868641247554" CRS="WGS84"/>
      ...
      <asset xsi:type="esdl:Joint" name="Joint_8fbf_ret" id="4bca66e2-92d1-47de-bbf0-0551ff715b52">
        <geometry xsi:type="esdl:Point" lon="4.372656936860683" lat="51.998272489887235" CRS="WGS84"/>
      ...
      <asset xsi:type="esdl:Joint" name="Joint_282a_ret" id="7067a514-0569-4148-aae3-547772e6fc86">
        <geometry xsi:type="esdl:Point" lon="4.371545495375693" lat="51.999742211587645" CRS="WGS84"/>
      ...
      <asset xsi:type="esdl:Joint" name="Joint_0573_ret" id="5b5bcd97-8ff2-4714-af80-771497d34b77">
        <geometry xsi:type="esdl:Point" lon="4.373554483969099" lat="51.99696786503158" CRS="WGS84"/>
      ...
      <asset xsi:type="esdl:Joint" name="Joint_2bec_ret" id="5f9f5272-b0aa-430e-bdd1-9b7f3e1e0ad9">
        <geometry xsi:type="esdl:Point" lon="4.371006344936896" lat="52.00030366556689" CRS="WGS84"/>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe1" diameter="DN200" name="Pipe1_ret" length="160.1" id="Pipe1_ret">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.373498068326272" lat="51.99694969910065" CRS="WGS84"/>
          <point xsi:type="esdl:Point" lon="4.371309552438089" lat="51.996439398574736" CRS="WGS84"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe2" diameter="DN200" name="Pipe2_ret" length="179.9" id="Pipe2_ret">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.372584413437383" lat="51.998251021684645" CRS="WGS84"/>
          <point xsi:type="esdl:Point" lon="4.370156674775391" lat="51.997628439330356" CRS="WGS84"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe3" diameter="DN200" name="Pipe3_ret" length="73.43" id="Pipe3_ret">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.372198467776014" lat="51.998868641247554" CRS="WGS84"/>
          <point xsi:type="esdl:Point" lon="4.372656936860683" lat="51.998272489887235" CRS="WGS84"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe4" diameter="DN200" name="Pipe4_ret" length="107.05" id="Pipe4_ret">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.371545495375693" lat="51.999742211587645" CRS="WGS84"/>
          <point xsi:type="esdl:Point" lon="4.372198467776014" lat="51.998868641247554" CRS="WGS84"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe5" diameter="DN200" name="Pipe5_ret" length="205.45" id="Pipe5_ret">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.373554483969099" lat="51.99696786503158" CRS="WGS84"/>
          <point xsi:type="esdl:Point" lon="4.373948780767135" lat="51.9964261868334" CRS="WGS84"/>
          <point xsi:type="esdl:Point" lon="4.375881926796532" lat="51.99682253737782" CRS="WGS84"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe6" diameter="DN200" name="Pipe6_ret" length="157.72" id="Pipe6_ret">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.372656936860683" lat="51.998272489887235" CRS="WGS84"/>
          <point xsi:type="esdl:Point" lon="4.372712895904377" lat="51.998196525431744" CRS="WGS84"/>
          <point xsi:type="esdl:Point" lon="4.373554483969099" lat="51.99696786503158" CRS="WGS84"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe7" diameter="DN200" name="Pipe7_ret" length="72.62" id="Pipe7_ret">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.371006344936896" lat="52.00030366556689" CRS="WGS84"/>
          <point xsi:type="esdl:Point" lon="4.371545495375693" lat="51.999742211587645" CRS="WGS84"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe8" diameter="DN200" name="Pipe8_ret" length="93.52" id="Pipe8_ret">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.371006344936896" lat="52.00030366556689" CRS="WGS84"/>
          <point xsi:type="esdl:Point" lon="4.37034997764605" lat="52.00104015040348" CRS="WGS84"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe9" diameter="DN200" name="Pipe9_ret" length="72.2" id="Pipe9_ret">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.372598048350767" lat="51.99998000472088" CRS="WGS84"/>
          <point xsi:type="esdl:Point" lon="4.37358086059924" lat="52.00021779659093" CRS="WGS84"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe10" diameter="DN200" name="Pipe10_ret" length="66.7" id="Pipe10_ret">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.370269927719944" lat="52.001129320390945" CRS="WGS84"/>
          <point xsi:type="esdl:Point" lon="4.369811045716992" lat="52.00165773148614" CRS="WGS84"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe11" diameter="DN200" name="Pipe11_ret" length="73.3" id="Pipe11_ret">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.370039408470301" lat="52.00001963678694" CRS="WGS84"/>
          <point xsi:type="esdl:Point" lon="4.371006344936896" lat="52.00030366556689" CRS="WGS84"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe13" diameter="DN200" name="Pipe13_ret" length="87.4" id="Pipe13_ret">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.3688791287127415" lat="51.999689368497606" CRS="WGS84"/>
          <point xsi:type="esdl:Point" lon="4.370039408470301" lat="52.00001963678694" CRS="WGS84"/>
        </geometry>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe14" diameter="DN200" name="Pipe14_ret" length="167.9" id="Pipe14_ret">
        <geometry xsi:type="esdl:Line">
          <point xsi:type="esdl:Point" lon="4.369860046832058" lat="51.99840790446648" CRS="WGS84"/>
          <point xsi:type="esdl:Point" lon="4.372198467776014" lat="51.998868641247554" CRS="WGS84"/>
        </geometry>
